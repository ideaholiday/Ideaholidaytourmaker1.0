                ...
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-200">
                    ...
                    {formData.type === 'ACTIVITY' && (
                        <div className="space-y-4">
                            ...
                            {/* Base Ticket Checkbox Logic */}
                            <div className={`p-4 rounded-lg border transition-all ${formData.ticketIncluded !== false ? 'bg-white border-brand-300 shadow-sm' : 'bg-slate-50 border-slate-200 opacity-75'}`}>
