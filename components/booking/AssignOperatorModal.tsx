...
import { X, UserPlus, CheckCircle, Lock, DollarSign } from 'lucide-react';
...
interface Props {
  ...
  currentNetCost: number; // This should be passed as the Raw Supplier Cost
  currency: string;
}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-blue-50 p-3 rounded-lg border border-blue-100 flex gap-2 items-start">
                ...
                <div className="text-xs text-blue-800">
                    <strong>Privacy Wall Active:</strong> The selected operator will NOT see the Agent's name, markup, or client selling price.
                </div>
            </div>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                ...
                <div className="space-y-3">
                    <label className="flex items-start gap-3 cursor-pointer p-2 hover:bg-slate-100 rounded transition">
                        ...
                        />
                        <div>
                            <span className="text-sm font-medium text-slate-800">Operational Cost</span>
                            <p className="text-xs text-slate-500">Share raw cost: <strong>{currency} {currentNetCost.toLocaleString()}</strong></p>
                        </div>
                    </label>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer p-2 hover:bg-slate-100 rounded transition">
                        ...
                        <div className="flex-1">
                            <span className="text-sm font-medium text-slate-800">Custom Fixed Amount</span>
                            <p className="text-xs text-slate-500 mb-2">Override actual cost.</p>
            ...
            <div>
                ...
                <textarea 
                    ...
                    placeholder="e.g. VIP Client, Use White Placard..."
                    value={instructions}
            ...
            <div className="flex justify-end gap-3 pt-2">
                ...
                <button type="submit" className="px-6 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 text-sm font-bold shadow-sm flex items-center gap-2">
